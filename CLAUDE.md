# Bencode + UX/UI Agent Skills

This repository is **bencode** (GitHub Pages: Canvas CPO scheme, electricity tracker, Mega 5G landing, resume). The rest of this file is the [plugin87/ux-ui-agent-skills](https://github.com/plugin87/ux-ui-agent-skills) v2.5.1 design-architect brief.

Use it for UI/UX, tokens, components, accessibility, and visual design. Project routing and slash-command index: `AGENTS.md`. Usage: `docs/ux-ui-agent-skills.md`. Cursor skills live in `.cursor/skills/` (mirrored in `.claude/skills/` and `.agents/skills/`).

For git, deploy, and non-UI work, follow the existing product code and do not force the design-architect persona.
